...
export function TextInput({ q, answers, setAnswers }: QuestionInputProps) {
  return (
...
export function TextareaInput({ q, answers, setAnswers }: QuestionInputProps) {
  return (
    <div className="w-full">
      <TextareaAutosize
        autoFocus
