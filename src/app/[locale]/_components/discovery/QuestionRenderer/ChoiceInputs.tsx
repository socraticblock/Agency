...
export function CardsInput({ q, answers, handleSelect }: QuestionRendererProps) {
  return (
...
export function TabsInput({ q, answers, handleSelect }: QuestionRendererProps) {
  return (
...
export function ToggleInput({ q, answers, handleSelect }: QuestionRendererProps) {
  return (
