...
export function TagsInput({ q, answers, handleSelect }: QuestionRendererProps) {
  return (
...
export function MultiSelectInput({ q, answers, toggleMultiSelectOption }: QuestionRendererProps) {
  return (
...
export function ColorPaletteInput({ q, answers, setAnswers }: QuestionRendererProps) {
  return (
