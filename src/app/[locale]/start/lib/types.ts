...
export interface StylePresetSelection {
  ...
  /** 50 = slow, 100 = default, 200 = fast (motion cycle). */
...
export function defaultLane1State(): Lane1CustomizerState {
  return {
    ...
    style: {
      ...
      textColorId: "white",
      accentId: "emerald",
      secondaryAccentId: "emerald",
      accentCustomPrimary: "#10b981",
      fontId: "modern",
      vibeId: "minimal",
      animationId: "fade",
      ...
      bgBaseBlur: 0,
      bgOverlayId: "none",
      bgOverlayColor1: "#10b981",
      bgOverlayColor2: "#059669",
      bgOverlayColor3: "#047857",
      bgOverlayAngle: 180,
