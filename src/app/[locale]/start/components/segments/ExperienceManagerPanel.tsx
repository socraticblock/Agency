      ...
      {open ? (
        <div className="absolute bottom-full left-1/2 mb-2 w-[min(100%,320px)] -translate-x-1/2 rounded-xl border border-white/20 bg-black/85 p-2 text-white shadow-2xl backdrop-blur-md">
          <div className="mb-2 flex items-center justify-between gap-2 px-1">
            <p className="text-xs font-bold uppercase tracking-wide text-white/80">Experience</p>
          ...
          <div className="max-h-[min(62vh,480px)] overflow-y-auto rounded-lg bg-white/95 p-3 text-slate-900 shadow-inner">
            ...
            <div className="[&_fieldset]:border-slate-200 [&_legend]:text-slate-700">
              ...
              <Phase5ExperienceControls state={state} patch={patch} onStylePatch={onStylePatch} />
            </div>
          </div>
        </div>
      ) : null}
