...
-- =============================================================================
-- Apply with: wrangler d1 migrations apply genezisi-cards --local
-- Or for production: wrangler d1 migrations apply genezisi-cards --remote
-- (requires: npx wrangler d1 migrations apply genezisi-cards --remote
